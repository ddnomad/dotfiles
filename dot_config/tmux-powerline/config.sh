...
# sqlite3 -list "/var/folders/x4/kbj5fz313glb2r5fmchmzd5h0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/ddnomad/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/ddnomad/.mailcheckrc"
# }
